...
public class PrimeNumber {
	public static void main(String args[]) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			// if matched then removing the prime number so that only prime number not present in list will remain in prime number array list
		...
		System.out.println("Missing Prime Numbers: " + prime_numbers);
